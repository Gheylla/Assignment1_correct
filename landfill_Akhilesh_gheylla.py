...
plt.plot(leachate.Cumulative_leach)
plt.grid()
plt.title('Observed leachate')
plt.xlabel('Year')
plt.ylabel('Leachate production')
...
acl = 0.005     #0.002 - 0.2
awb = 0.001     #0.002 - 0.2 or <0.002
Scl_max = 0.60  # 0.55~0.69
Swb_max = 5.5   # 4.4~5.5
Scl_min = 0.2     
Swb_min = 0.2
beta0 = 0.98    # 0~1
...
plt.ylabel('Drainage[m] difference')
plt.title('Squared root differences')
plt.legend()
plt.grid();
